...
## 🔒 Privacidad
La demo es **100% anónima** (Project A…J). Los datos personales, conversaciones y bases de datos reales quedan **fuera del
paquete** (`foundations/_private/`, git-ignored). Antes de publicar, ejecuta la sanitización de
[`github_load.md`](foundations/github_load.md).

---

**Framework "Gestão de Projetos (PM) IA com Painel BSC e DashBoard"** · ©️ Bruno Teixeira Penedo — 2026. Todos los derechos reservados. E-mail: bpenedo@gmail.com
